...
1. **GitHub Private Vulnerability Reporting**
   Use the "Report a vulnerability" button on the [Security tab](https://github.com/IvanAnishchuk/geek42/security/advisories/new)
   of this repository. This creates a private advisory visible only to
   maintainers.

2. **Encrypted email**
   Send to `ivan@agorism.org` (update with real contact) encrypted with
   the maintainer's public key published at `https://github.com/IvanAnishchuk.gpg`.
