...
- Allow IvanAnishchuk, and select non-IvanAnishchuk, actions and reusable workflows
...
3. Under "Add a new pending publisher", fill in:
   - **Project name**: `geek42`
   - **Owner**: `IvanAnishchuk` (your GitHub org or user)
...
2. "Add new project"
3. Repository URL: `https://github.com/IvanAnishchuk/geek42`
